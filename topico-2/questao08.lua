...
aresta1, aresta2, aresta3, aresta4= io.read("*n", "*n", "*n", "*n")

if(aresta1 == aresta2 and aresta3 == aresta4) or (aresta1 == aresta3 and aresta2 == aresta4) or(aresta1 == aresta4 and aresta3 == aresta2) or (aresta3 == aresta2 and aresta4 == aresta1) then
