...
q1, q2, q3 = io.read("*n", "*n", "*n")

if((q1%2 == 0 and q2%2 == 0) or (q1%2 == 0 and q3%2 == 0) or (q2%2 == 0 and q3%2 == 0) and (q1%3 == 0 and q2%3 == 0) or (q1%3 == 0 and q3%3 == 0) or (q2%3 == 0 and q3%3 == 0)) then

print("tem dois pares ai e dois multiplos de 3")
end
